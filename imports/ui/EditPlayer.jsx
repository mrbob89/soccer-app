                ...
                <form className="col s12" onSubmit={this.editPlayer.bind(this)}>
                    ...
                    <div className="row">
                        <div className="input-field col s6">
                            ...
                            <select className="browser-default" ref="ballManipulation" defaultValue={currentPlayer.ballManipulation}>
                                <option value="0">0 - Hasn't demonstrate skills</option>
                                <option value="1">1 - Needs improvment</option>
                    ...
                    <div className="row">
                        <div className="input-field col s12">
                            <textarea placeholder="Notes" ref="notes" className="materialize-textarea" defaultValue={currentPlayer.notes}></textarea>
                        </div>
                    </div>
                    <div className="row">
                        <div className="input-field col s12">
